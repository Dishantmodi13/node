...
* \[[`7bdcc93cdc`](https://github.com/nodejs/node/commit/7bdcc93cdc)] - **assert**: use a set instead of an array for faster lookup (Ruben Bridgewater) [#61076](https://github.com/nodejs/node/pull/61076)
* \[[`5ae7067f36`](https://github.com/nodejs/node/commit/5ae7067f36)] - **assert,util**: fix deep comparison for sets and maps with mixed types (Ruben Bridgewater) [#61388](https://github.com/nodejs/node/pull/61388)
* \[[`52d1bc4537`](https://github.com/nodejs/node/commit/52d1bc4537)] - **benchmark**: add SQLite benchmarks (Guilherme Araújo) [#61401](https://github.com/nodejs/node/pull/61401)
* \[[`0451cad8eb`](https://github.com/nodejs/node/commit/0451cad8eb)] - **benchmark**: use boolean options in benchmark tests (SeokhunEom) [#60129](https://github.com/nodejs/node/pull/60129)
* \[[`0be7286246`](https://github.com/nodejs/node/commit/0be7286246)] - **benchmark**: allow boolean option values (SeokhunEom) [#60129](https://github.com/nodejs/node/pull/60129)
* \[[`02a9c7409f`](https://github.com/nodejs/node/commit/02a9c7409f)] - **benchmark**: fix incorrect base64 input in byteLength benchmark (semimikoh) [#60841](https://github.com/nodejs/node/pull/60841)
* \[[`a77708aa03`](https://github.com/nodejs/node/commit/a77708aa03)] - **benchmark**: use typescript for import cjs benchmark (Joyee Cheung) [#60663](https://github.com/nodejs/node/pull/60663)
* \[[`64aec13081`](https://github.com/nodejs/node/commit/64aec13081)] - **benchmark**: focus on import.meta intialization in import-meta benchmark (Joyee Cheung) [#60603](https://github.com/nodejs/node/pull/60603)
* \[[`1300abde5c`](https://github.com/nodejs/node/commit/1300abde5c)] - **benchmark**: add per-suite setup option (Joyee Cheung) [#60574](https://github.com/nodejs/node/pull/60574)
...
* \[[`66102e1586`](https://github.com/nodejs/node/commit/66102e1586)] - **buffer**: let Buffer.of use heap (Сковорода Никита Андреевич) [#60503](https://github.com/nodejs/node/pull/60503)
* \[[`85bf8faab2`](https://github.com/nodejs/node/commit/85bf8faab2)] - **buffer**: speed up concat via TypedArray#set (Gürgün Dayıoğlu) [#60399](https://github.com/nodejs/node/pull/60399)
* \[[`ab53c32f63`](https://github.com/nodejs/node/commit/ab53c32f63)] - **build**: skip sscache action on non-main branches (Joyee Cheung) [#61790](https://github.com/nodejs/node/pull/61790)
* \[[`540c6b795d`](https://github.com/nodejs/node/commit/540c6b795d)] - **build**: update android-patches/trap-handler.h.patch (Mo Luo) [#60369](https://github.com/nodejs/node/pull/60369)
* \[[`6a0c9d1c08`](https://github.com/nodejs/node/commit/6a0c9d1c08)] - **build**: update devcontainer.json to use paired nix env (Joyee Cheung) [#61414](https://github.com/nodejs/node/pull/61414)
* \[[`6267ea9474`](https://github.com/nodejs/node/commit/6267ea9474)] - **build**: fix misplaced comma in ldflags (hqzing) [#61294](https://github.com/nodejs/node/pull/61294)
* \[[`96867b1d86`](https://github.com/nodejs/node/commit/96867b1d86)] - **build**: fix crate vendor file checksums on windows (Chengzhong Wu) [#61329](https://github.com/nodejs/node/pull/61329)
* \[[`ed8daae301`](https://github.com/nodejs/node/commit/ed8daae301)] - **build**: fix inconsistent quoting in `Makefile` (Antoine du Hamel) [#60511](https://github.com/nodejs/node/pull/60511)
* \[[`ed53b4d506`](https://github.com/nodejs/node/commit/ed53b4d506)] - **build**: remove temporal updater (Chengzhong Wu) [#61151](https://github.com/nodejs/node/pull/61151)
* \[[`509d4344d6`](https://github.com/nodejs/node/commit/509d4344d6)] - **build**: update test-wpt-report to use NODE instead of OUT\_NODE (Filip Skokan) [#61024](https://github.com/nodejs/node/pull/61024)
* \[[`78bd0bc47a`](https://github.com/nodejs/node/commit/78bd0bc47a)] - **build**: skip build-ci on actions with a separate test step (Chengzhong Wu) [#61073](https://github.com/nodejs/node/pull/61073)
* \[[`61ec85d848`](https://github.com/nodejs/node/commit/61ec85d848)] - **build**: run embedtest with node\_g when BUILDTYPE=Debug (Chengzhong Wu) [#60850](https://github.com/nodejs/node/pull/60850)
* \[[`ad51085f62`](https://github.com/nodejs/node/commit/ad51085f62)] - **build**: upgrade Python linter ruff, add rules ASYNC,PERF (Christian Clauss) [#59984](https://github.com/nodejs/node/pull/59984)
...
* \[[`e3dc2549df`](https://github.com/nodejs/node/commit/e3dc2549df)] - **build,tools**: fix addon build deadlock on errors (Vladimir Morozov) [#61321](https://github.com/nodejs/node/pull/61321)
* \[[`f68d1f1df4`](https://github.com/nodejs/node/commit/f68d1f1df4)] - **build,win**: update WinGet configurations to Python 3.14 (Mike McCready) [#61431](https://github.com/nodejs/node/pull/61431)
* \[[`ac28e05383`](https://github.com/nodejs/node/commit/ac28e05383)] - **child\_process**: treat ipc length header as unsigned uint32 (Ryuhei Shima) [#61344](https://github.com/nodejs/node/pull/61344)
* \[[`580ce8c099`](https://github.com/nodejs/node/commit/580ce8c099)] - **cli**: mark --heapsnapshot-near-heap-limit as stable (Joyee Cheung) [#60956](https://github.com/nodejs/node/pull/60956)
* \[[`f9cd179a8a`](https://github.com/nodejs/node/commit/f9cd179a8a)] - **cluster**: fix port reuse between cluster (Ryuhei Shima) [#60141](https://github.com/nodejs/node/pull/60141)
* \[[`90869da9f9`](https://github.com/nodejs/node/commit/90869da9f9)] - **console**: optimize single-string logging (Gürgün Dayıoğlu) [#60422](https://github.com/nodejs/node/pull/60422)
* \[[`d950b151a2`](https://github.com/nodejs/node/commit/d950b151a2)] - **crypto**: update root certificates to NSS 3.119 (Node.js GitHub Bot) [#61419](https://github.com/nodejs/node/pull/61419)
* \[[`4f42f8c428`](https://github.com/nodejs/node/commit/4f42f8c428)] - **crypto**: update root certificates to NSS 3.117 (Node.js GitHub Bot) [#60741](https://github.com/nodejs/node/pull/60741)
...
* \[[`b45e4ee985`](https://github.com/nodejs/node/commit/b45e4ee985)] - **debugger**: fix event listener leak in the run command (Joyee Cheung) [#60464](https://github.com/nodejs/node/pull/60464)
* \[[`18be880f7d`](https://github.com/nodejs/node/commit/18be880f7d)] - **deps**: update googletest to 85087857ad10bd407cd6ed2f52f7ea9752db621f (Node.js GitHub Bot) [#61417](https://github.com/nodejs/node/pull/61417)
* \[[`a46935660c`](https://github.com/nodejs/node/commit/a46935660c)] - **deps**: update sqlite to 3.51.2 (Node.js GitHub Bot) [#61339](https://github.com/nodejs/node/pull/61339)
* \[[`a5d38c6d7c`](https://github.com/nodejs/node/commit/a5d38c6d7c)] - **deps**: update icu to 78.2 (Node.js GitHub Bot) [#60523](https://github.com/nodejs/node/pull/60523)
* \[[`b748a51b83`](https://github.com/nodejs/node/commit/b748a51b83)] - **deps**: update zlib to 1.3.1-e00f703 (Node.js GitHub Bot) [#61135](https://github.com/nodejs/node/pull/61135)
* \[[`c4941613b3`](https://github.com/nodejs/node/commit/c4941613b3)] - **deps**: update cjs-module-lexer to 2.2.0 (Node.js GitHub Bot) [#61271](https://github.com/nodejs/node/pull/61271)
* \[[`e8d35c423d`](https://github.com/nodejs/node/commit/e8d35c423d)] - **deps**: update nbytes to 0.1.2 (Node.js GitHub Bot) [#61270](https://github.com/nodejs/node/pull/61270)
* \[[`a8801739da`](https://github.com/nodejs/node/commit/a8801739da)] - **deps**: update timezone to 2025c (Node.js GitHub Bot) [#61138](https://github.com/nodejs/node/pull/61138)
* \[[`1754db7566`](https://github.com/nodejs/node/commit/1754db7566)] - **deps**: update simdjson to 4.2.4 (Node.js GitHub Bot) [#61056](https://github.com/nodejs/node/pull/61056)
* \[[`c4dba168c9`](https://github.com/nodejs/node/commit/c4dba168c9)] - **deps**: update googletest to 065127f1e4b46c5f14fc73cf8d323c221f9dc68e (Node.js GitHub Bot) [#61055](https://github.com/nodejs/node/pull/61055)
* \[[`c2088f6983`](https://github.com/nodejs/node/commit/c2088f6983)] - **deps**: update sqlite to 3.51.1 (Node.js GitHub Bot) [#60899](https://github.com/nodejs/node/pull/60899)
* \[[`054171adfb`](https://github.com/nodejs/node/commit/054171adfb)] - **deps**: update zlib to 1.3.1-63d7e16 (Node.js GitHub Bot) [#60898](https://github.com/nodejs/node/pull/60898)
* \[[`9b824117f9`](https://github.com/nodejs/node/commit/9b824117f9)] - **deps**: update sqlite to 3.51.0 (Node.js GitHub Bot) [#60614](https://github.com/nodejs/node/pull/60614)
* \[[`53bb670f07`](https://github.com/nodejs/node/commit/53bb670f07)] - **deps**: update simdjson to 4.2.2 (Node.js GitHub Bot) [#60740](https://github.com/nodejs/node/pull/60740)
* \[[`d1092514f5`](https://github.com/nodejs/node/commit/d1092514f5)] - **deps**: update googletest to 1b96fa13f549387b7549cc89e1a785cf143a1a50 (Node.js GitHub Bot) [#60739](https://github.com/nodejs/node/pull/60739)
* \[[`d7ad35a19e`](https://github.com/nodejs/node/commit/d7ad35a19e)] - **deps**: update minimatch to 10.1.1 (Node.js GitHub Bot) [#60543](https://github.com/nodejs/node/pull/60543)
* \[[`ce660284bc`](https://github.com/nodejs/node/commit/ce660284bc)] - **deps**: update cjs-module-lexer to 2.1.1 (Node.js GitHub Bot) [#60646](https://github.com/nodejs/node/pull/60646)
* \[[`bc415e3f5e`](https://github.com/nodejs/node/commit/bc415e3f5e)] - **deps**: update simdjson to 4.2.1 (Node.js GitHub Bot) [#60644](https://github.com/nodejs/node/pull/60644)
* \[[`d7d907386e`](https://github.com/nodejs/node/commit/d7d907386e)] - **deps**: update simdjson to 4.1.0 (Node.js GitHub Bot) [#60542](https://github.com/nodejs/node/pull/60542)
* \[[`f86c8fc80e`](https://github.com/nodejs/node/commit/f86c8fc80e)] - **deps**: update amaro to 1.1.5 (Node.js GitHub Bot) [#60541](https://github.com/nodejs/node/pull/60541)
...
* \[[`737d3df2b3`](https://github.com/nodejs/node/commit/737d3df2b3)] - **doc**: move Security-Team from TSC to SECURITY (Rafael Gonzaga) [#61495](https://github.com/nodejs/node/pull/61495)
* \[[`bdc558fc5f`](https://github.com/nodejs/node/commit/bdc558fc5f)] - **doc**: added `requestOCSP` option to `tls.connect` (ikeyan) [#61064](https://github.com/nodejs/node/pull/61064)
* \[[`25c6c6ef2b`](https://github.com/nodejs/node/commit/25c6c6ef2b)] - **doc**: restore @ChALkeR to collaborators (Сковорода Никита Андреевич) [#61553](https://github.com/nodejs/node/pull/61553)
* \[[`58456e80ac`](https://github.com/nodejs/node/commit/58456e80ac)] - **doc**: update IBM/Red Hat volunteers with dedicated project time (Beth Griggs) [#61588](https://github.com/nodejs/node/pull/61588)
* \[[`98f9bc6367`](https://github.com/nodejs/node/commit/98f9bc6367)] - **doc**: mention constructor comparison in assert.deepStrictEqual (Hamza Kargin) [#60253](https://github.com/nodejs/node/pull/60253)
* \[[`1cc10b4079`](https://github.com/nodejs/node/commit/1cc10b4079)] - **doc**: add CVE delay mention (Rafael Gonzaga) [#61465](https://github.com/nodejs/node/pull/61465)
* \[[`0d7940abeb`](https://github.com/nodejs/node/commit/0d7940abeb)] - **doc**: include OpenJSF handle for security stewards (Rafael Gonzaga) [#61454](https://github.com/nodejs/node/pull/61454)
* \[[`dda0561da7`](https://github.com/nodejs/node/commit/dda0561da7)] - **doc**: clarify process.argv\[1] behavior for -e/--eval (Jeevankumar S) [#61366](https://github.com/nodejs/node/pull/61366)
* \[[`c4486aebf0`](https://github.com/nodejs/node/commit/c4486aebf0)] - **doc**: remove Windows Dev Home instructions from BUILDING (Mike McCready) [#61434](https://github.com/nodejs/node/pull/61434)
* \[[`293245e9f5`](https://github.com/nodejs/node/commit/293245e9f5)] - **doc**: clarify TypedArray properties on Buffer (Roman Reiss) [#61355](https://github.com/nodejs/node/pull/61355)
* \[[`0f6af25bae`](https://github.com/nodejs/node/commit/0f6af25bae)] - **doc**: note resume build should not be done on node-test-commit (Stewart X Addison) [#61373](https://github.com/nodejs/node/pull/61373)
* \[[`3e96f9c27c`](https://github.com/nodejs/node/commit/3e96f9c27c)] - **doc**: refine WebAssembly error documentation (sangwook) [#61382](https://github.com/nodejs/node/pull/61382)
* \[[`8167de5352`](https://github.com/nodejs/node/commit/8167de5352)] - **doc**: add deprecation history for url.parse (Eng Zer Jun) [#61389](https://github.com/nodejs/node/pull/61389)
* \[[`4ee5399ab9`](https://github.com/nodejs/node/commit/4ee5399ab9)] - **doc**: add marco and rafael in last sec release (Marco Ippolito) [#61383](https://github.com/nodejs/node/pull/61383)
* \[[`d5e4bb748d`](https://github.com/nodejs/node/commit/d5e4bb748d)] - **doc**: packages: example of private import switch to internal (coderaiser) [#61343](https://github.com/nodejs/node/pull/61343)
* \[[`a359711afc`](https://github.com/nodejs/node/commit/a359711afc)] - **doc**: add esm and cjs examples to node:v8 (Alfredo González) [#61328](https://github.com/nodejs/node/pull/61328)
* \[[`af330c5fe1`](https://github.com/nodejs/node/commit/af330c5fe1)] - **doc**: added 'secure' event to tls.TLSSocket (ikeyan) [#61066](https://github.com/nodejs/node/pull/61066)
* \[[`d8fef35b15`](https://github.com/nodejs/node/commit/d8fef35b15)] - **doc**: restore @watilde to collaborators (Daijiro Wachi) [#61350](https://github.com/nodejs/node/pull/61350)
* \[[`a61bba407b`](https://github.com/nodejs/node/commit/a61bba407b)] - **doc**: run license-builder (github-actions\[bot]) [#61348](https://github.com/nodejs/node/pull/61348)
* \[[`b00780da13`](https://github.com/nodejs/node/commit/b00780da13)] - **doc**: document ALPNCallback option for TLSSocket constructor (ikeyan) [#61331](https://github.com/nodejs/node/pull/61331)
* \[[`dc63cb1181`](https://github.com/nodejs/node/commit/dc63cb1181)] - **doc**: update MDN links (Livia Medeiros) [#61062](https://github.com/nodejs/node/pull/61062)
* \[[`4646a30b0e`](https://github.com/nodejs/node/commit/4646a30b0e)] - **doc**: add documentation for process.traceProcessWarnings (Alireza Ebrahimkhani) [#53641](https://github.com/nodejs/node/pull/53641)
* \[[`cc1ff6c82c`](https://github.com/nodejs/node/commit/cc1ff6c82c)] - **doc**: add sqlite session disposal method (René) [#61273](https://github.com/nodejs/node/pull/61273)
* \[[`18e71ab986`](https://github.com/nodejs/node/commit/18e71ab986)] - **doc**: fix filename typo (Hardanish Singh) [#61297](https://github.com/nodejs/node/pull/61297)
* \[[`5c2afdc1db`](https://github.com/nodejs/node/commit/5c2afdc1db)] - **doc**: fix typos and grammar in `BUILDING.md` & `onboarding.md` (Hardanish Singh) [#61267](https://github.com/nodejs/node/pull/61267)
* \[[`5478a16c4c`](https://github.com/nodejs/node/commit/5478a16c4c)] - **doc**: mention --newVersion release script (Rafael Gonzaga) [#61255](https://github.com/nodejs/node/pull/61255)
* \[[`0d8c4076e4`](https://github.com/nodejs/node/commit/0d8c4076e4)] - **doc**: correct typo in api contributing doc (Mike McCready) [#61260](https://github.com/nodejs/node/pull/61260)
* \[[`ab39b6b994`](https://github.com/nodejs/node/commit/ab39b6b994)] - **doc**: add PR-URL requirement for security backports (Rafael Gonzaga) [#61256](https://github.com/nodejs/node/pull/61256)
* \[[`ec9b284821`](https://github.com/nodejs/node/commit/ec9b284821)] - **doc**: add reusePort error behavior to net module (mag123c) [#61250](https://github.com/nodejs/node/pull/61250)
* \[[`86731acd2e`](https://github.com/nodejs/node/commit/86731acd2e)] - **doc**: note corepack package removal in distribution doc (Mike McCready) [#61207](https://github.com/nodejs/node/pull/61207)
* \[[`6946f6c7e4`](https://github.com/nodejs/node/commit/6946f6c7e4)] - **doc**: fix tls.connect() timeout documentation (Azad Gupta) [#61079](https://github.com/nodejs/node/pull/61079)
* \[[`622c5f681e`](https://github.com/nodejs/node/commit/622c5f681e)] - **doc**: missing `passed`, `error` and `passed` properties on `TestContext` (Xavier Stouder) [#61185](https://github.com/nodejs/node/pull/61185)
* \[[`9c2909a4d5`](https://github.com/nodejs/node/commit/9c2909a4d5)] - **doc**: clarify threat model for application-level API exposure (Rafael Gonzaga) [#61184](https://github.com/nodejs/node/pull/61184)
* \[[`d8f64b1775`](https://github.com/nodejs/node/commit/d8f64b1775)] - **doc**: correct options for net.Socket class and socket.connect (Xavier Stouder) [#61179](https://github.com/nodejs/node/pull/61179)
* \[[`53c0fdebba`](https://github.com/nodejs/node/commit/53c0fdebba)] - **doc**: document error event on readline InterfaceConstructor (Xavier Stouder) [#61170](https://github.com/nodejs/node/pull/61170)
* \[[`1dc625ed17`](https://github.com/nodejs/node/commit/1dc625ed17)] - **doc**: add a smooth scrolling effect to the sidebar (btea) [#59007](https://github.com/nodejs/node/pull/59007)
* \[[`de2bd1eb1d`](https://github.com/nodejs/node/commit/de2bd1eb1d)] - **doc**: correct invalid collaborator profile (JJ) [#61091](https://github.com/nodejs/node/pull/61091)
* \[[`601646bfd8`](https://github.com/nodejs/node/commit/601646bfd8)] - **doc**: exclude compile-time flag features from security policy (Matteo Collina) [#61109](https://github.com/nodejs/node/pull/61109)
* \[[`9dc1ec740d`](https://github.com/nodejs/node/commit/9dc1ec740d)] - **doc**: add @avivkeller to collaborators (Aviv Keller) [#61115](https://github.com/nodejs/node/pull/61115)
* \[[`9b23f7cd7b`](https://github.com/nodejs/node/commit/9b23f7cd7b)] - **doc**: add gurgunday to collaborators (Gürgün Dayıoğlu) [#61094](https://github.com/nodejs/node/pull/61094)
* \[[`fe4db3593e`](https://github.com/nodejs/node/commit/fe4db3593e)] - **doc**: add File modes cross-references in fs methods (Mohit Raj Saxena) [#60286](https://github.com/nodejs/node/pull/60286)
* \[[`b0c6377539`](https://github.com/nodejs/node/commit/b0c6377539)] - **doc**: add missing `zstd` to mjs example of zlib (Deokjin Kim) [#60915](https://github.com/nodejs/node/pull/60915)
* \[[`cad312ab77`](https://github.com/nodejs/node/commit/cad312ab77)] - **doc**: clarify fileURLToPath security considerations (Rafael Gonzaga) [#60887](https://github.com/nodejs/node/pull/60887)
* \[[`0660d9c253`](https://github.com/nodejs/node/commit/0660d9c253)] - **doc**: replace column with columnNumber in example of `util.getCallSites` (Deokjin Kim) [#60881](https://github.com/nodejs/node/pull/60881)
* \[[`073ea7ed3e`](https://github.com/nodejs/node/commit/073ea7ed3e)] - **doc**: correct spelling in BUILDING.md (Rich Trott) [#60875](https://github.com/nodejs/node/pull/60875)
* \[[`2c0e6f2225`](https://github.com/nodejs/node/commit/2c0e6f2225)] - **doc**: update debuglog examples to use 'foo-bar' instead of 'foo' (xiaoyao) [#60867](https://github.com/nodejs/node/pull/60867)
* \[[`d6573c47cc`](https://github.com/nodejs/node/commit/d6573c47cc)] - **doc**: fix typos in changelogs (Rich Trott) [#60855](https://github.com/nodejs/node/pull/60855)
* \[[`7a2786cdf5`](https://github.com/nodejs/node/commit/7a2786cdf5)] - **doc**: mark module.register as active development (Chengzhong Wu) [#60849](https://github.com/nodejs/node/pull/60849)
* \[[`94c749cce3`](https://github.com/nodejs/node/commit/94c749cce3)] - **doc**: add fullName property to SuiteContext (PaulyBearCoding) [#60762](https://github.com/nodejs/node/pull/60762)
* \[[`5b3c4d322b`](https://github.com/nodejs/node/commit/5b3c4d322b)] - **doc**: keep sidebar module visible when navigating docs (Botato) [#60410](https://github.com/nodejs/node/pull/60410)
* \[[`5eec17fa72`](https://github.com/nodejs/node/commit/5eec17fa72)] - **doc**: correct concurrency wording in test() documentation (Azad Gupta) [#60773](https://github.com/nodejs/node/pull/60773)
* \[[`160e0ffaa5`](https://github.com/nodejs/node/commit/160e0ffaa5)] - **doc**: clarify that CQ only picks up PRs targeting `main` (René) [#60731](https://github.com/nodejs/node/pull/60731)
* \[[`2f265849b6`](https://github.com/nodejs/node/commit/2f265849b6)] - **doc**: clarify license section and add contributor note (KaleruMadhu) [#60590](https://github.com/nodejs/node/pull/60590)
* \[[`8149d5c9ff`](https://github.com/nodejs/node/commit/8149d5c9ff)] - **doc**: correct tls ALPNProtocols types (René) [#60143](https://github.com/nodejs/node/pull/60143)
* \[[`f447d014c9`](https://github.com/nodejs/node/commit/f447d014c9)] - **doc**: remove mention of SMS 2FA (Antoine du Hamel) [#60707](https://github.com/nodejs/node/pull/60707)
* \[[`01a5eb1bc9`](https://github.com/nodejs/node/commit/01a5eb1bc9)] - **doc**: `domain.add()` does not accept timer objects (René) [#60675](https://github.com/nodejs/node/pull/60675)
* \[[`b20244d9c0`](https://github.com/nodejs/node/commit/b20244d9c0)] - **doc**: update Collaborators list to reflect hybrist handle change (Antoine du Hamel) [#60650](https://github.com/nodejs/node/pull/60650)
* \[[`1aebd662b3`](https://github.com/nodejs/node/commit/1aebd662b3)] - **doc**: fix linter issues (Antoine du Hamel) [#60636](https://github.com/nodejs/node/pull/60636)
* \[[`f6c62c5055`](https://github.com/nodejs/node/commit/f6c62c5055)] - **doc**: correct values/references for buffer.kMaxLength (René) [#60305](https://github.com/nodejs/node/pull/60305)
* \[[`17156a358f`](https://github.com/nodejs/node/commit/17156a358f)] - **doc**: recommend events.once to manage 'close' event (Dan Fabulich) [#60017](https://github.com/nodejs/node/pull/60017)
* \[[`6e26cccaa9`](https://github.com/nodejs/node/commit/6e26cccaa9)] - **doc**: highlight module loading difference between import and require (Ajay A) [#59815](https://github.com/nodejs/node/pull/59815)
* \[[`fba74a5ec3`](https://github.com/nodejs/node/commit/fba74a5ec3)] - **doc**: fix typo in `process.unref` documentation (우혁) [#59698](https://github.com/nodejs/node/pull/59698)
* \[[`45eab53aa3`](https://github.com/nodejs/node/commit/45eab53aa3)] - **doc**: add some entries to `glossary.md` (Mohataseem Khan) [#59277](https://github.com/nodejs/node/pull/59277)
* \[[`9f83552f4e`](https://github.com/nodejs/node/commit/9f83552f4e)] - **doc**: improve agent.createConnection docs for http and https agents (JaeHo Jang) [#58205](https://github.com/nodejs/node/pull/58205)
* \[[`df46ffd0f7`](https://github.com/nodejs/node/commit/df46ffd0f7)] - **doc**: fix pseudo code in modules.md (chirsz) [#57677](https://github.com/nodejs/node/pull/57677)
* \[[`f5379c5392`](https://github.com/nodejs/node/commit/f5379c5392)] - **doc**: add missing variable in code snippet (Koushil Mankali) [#55478](https://github.com/nodejs/node/pull/55478)
* \[[`2b85a9be43`](https://github.com/nodejs/node/commit/2b85a9be43)] - **doc**: add missing word in `single-executable-applications.md` (Konstantin Tsabolov) [#53864](https://github.com/nodejs/node/pull/53864)
* \[[`c026a57ba1`](https://github.com/nodejs/node/commit/c026a57ba1)] - **doc**: fix typo in http.md (Michael Solomon) [#59354](https://github.com/nodejs/node/pull/59354)
* \[[`e3a90da3d7`](https://github.com/nodejs/node/commit/e3a90da3d7)] - **doc**: update devcontainer.json and add documentation (Joyee Cheung) [#60472](https://github.com/nodejs/node/pull/60472)
* \[[`eb0d2d2337`](https://github.com/nodejs/node/commit/eb0d2d2337)] - **doc**: add haramj as triager (Haram Jeong) [#60348](https://github.com/nodejs/node/pull/60348)
* \[[`6ede597849`](https://github.com/nodejs/node/commit/6ede597849)] - **doc**: clarify require(esm) description (dynst) [#60520](https://github.com/nodejs/node/pull/60520)
* \[[`9495172222`](https://github.com/nodejs/node/commit/9495172222)] - **doc**: instantiate resolver object (Donghoon Nam) [#60476](https://github.com/nodejs/node/pull/60476)
* \[[`631f18c3ea`](https://github.com/nodejs/node/commit/631f18c3ea)] - **doc**: clarify --use-system-ca support status (Joyee Cheung) [#60340](https://github.com/nodejs/node/pull/60340)
...
* \[[`61242255d2`](https://github.com/nodejs/node/commit/61242255d2)] - **esm**: avoid throw when module specifier is not url (Craig Macomber (Microsoft)) [#61000](https://github.com/nodejs/node/pull/61000)
* \[[`52ca6f646f`](https://github.com/nodejs/node/commit/52ca6f646f)] - **events**: remove redundant todo (Gürgün Dayıoğlu) [#60595](https://github.com/nodejs/node/pull/60595)
* \[[`3cca6d4eaa`](https://github.com/nodejs/node/commit/3cca6d4eaa)] - **events**: remove eventtarget custom inspect branding (Efe) [#61128](https://github.com/nodejs/node/pull/61128)
* \[[`7310139681`](https://github.com/nodejs/node/commit/7310139681)] - **fs**: remove duplicate getValidatedPath calls (Mert Can Altin) [#61359](https://github.com/nodejs/node/pull/61359)
* \[[`184888cc14`](https://github.com/nodejs/node/commit/184888cc14)] - **fs**: fix errorOnExist behavior for directory copy in fs.cp (Nicholas Paun) [#60946](https://github.com/nodejs/node/pull/60946)
* \[[`10c441fea6`](https://github.com/nodejs/node/commit/10c441fea6)] - **fs**: fix ENOTDIR in globSync when file is treated as dir (sangwook) [#61259](https://github.com/nodejs/node/pull/61259)
* \[[`d898adccfb`](https://github.com/nodejs/node/commit/d898adccfb)] - **fs**: remove duplicate fd validation in sync functions (Mert Can Altin) [#61361](https://github.com/nodejs/node/pull/61361)
* \[[`9129a947f3`](https://github.com/nodejs/node/commit/9129a947f3)] - **fs**: detect dot files when using globstar (Robin van Wijngaarden) [#61012](https://github.com/nodejs/node/pull/61012)
...
* \[[`6ef668e91a`](https://github.com/nodejs/node/commit/6ef668e91a)] - **gyp**: aix: change gcc version detection so CXX="ccache g++" works (Stewart X Addison) [#61464](https://github.com/nodejs/node/pull/61464)
* \[[`059b230b9f`](https://github.com/nodejs/node/commit/059b230b9f)] - **http**: fix rawHeaders exceeding maxHeadersCount limit (Max Harari) [#61285](https://github.com/nodejs/node/pull/61285)
* \[[`1ea7040192`](https://github.com/nodejs/node/commit/1ea7040192)] - **http**: replace startsWith with strict equality (btea) [#59394](https://github.com/nodejs/node/pull/59394)
...
* \[[`b09292fdde`](https://github.com/nodejs/node/commit/b09292fdde)] - **http,https**: fix double ERR\_PROXY\_TUNNEL emission (Shima Ryuhei) [#60699](https://github.com/nodejs/node/pull/60699)
* \[[`4ef2ba647a`](https://github.com/nodejs/node/commit/4ef2ba647a)] - **http2**: add diagnostics channels for client stream request body (Darshan Sen) [#60480](https://github.com/nodejs/node/pull/60480)
...
* \[[`0afd9c2b14`](https://github.com/nodejs/node/commit/0afd9c2b14)] - **inspector**: inspect HTTP response body (Chengzhong Wu) [#60572](https://github.com/nodejs/node/pull/60572)
...
* \[[`1865f887b6`](https://github.com/nodejs/node/commit/1865f887b6)] - **lib**: fix typo in `util.js` comment (Taejin Kim) [#61365](https://github.com/nodejs/node/pull/61365)
* \[[`1daffe725e`](https://github.com/nodejs/node/commit/1daffe725e)] - **lib**: fix TypeScript support check in jitless mode (sangwook) [#61382](https://github.com/nodejs/node/pull/61382)
* \[[`2b9850b4a9`](https://github.com/nodejs/node/commit/2b9850b4a9)] - **lib**: gbk decoder is gb18030 decoder per spec (Сковорода Никита Андреевич) [#61099](https://github.com/nodejs/node/pull/61099)
* \[[`7ca3e59e54`](https://github.com/nodejs/node/commit/7ca3e59e54)] - **lib**: enforce use of `URLParse` (Antoine du Hamel) [#61016](https://github.com/nodejs/node/pull/61016)
* \[[`d267005852`](https://github.com/nodejs/node/commit/d267005852)] - **lib**: use `FastBuffer` for empty buffer allocation (Gürgün Dayıoğlu) [#60558](https://github.com/nodejs/node/pull/60558)
...
* \[[`fc6c463c7d`](https://github.com/nodejs/node/commit/fc6c463c7d)] - **meta**: do not fast-track npm updates (Antoine du Hamel) [#61475](https://github.com/nodejs/node/pull/61475)
* \[[`b21d063af0`](https://github.com/nodejs/node/commit/b21d063af0)] - **meta**: fix typos in issue template config (Daijiro Wachi) [#61399](https://github.com/nodejs/node/pull/61399)
* \[[`253e968c9d`](https://github.com/nodejs/node/commit/253e968c9d)] - **meta**: label v8 module PRs (René) [#61325](https://github.com/nodejs/node/pull/61325)
* \[[`3ab41354f9`](https://github.com/nodejs/node/commit/3ab41354f9)] - **meta**: bump step-security/harden-runner from 2.13.2 to 2.14.0 (dependabot\[bot]) [#61245](https://github.com/nodejs/node/pull/61245)
* \[[`ddad61d9a0`](https://github.com/nodejs/node/commit/ddad61d9a0)] - **meta**: bump actions/setup-node from 6.0.0 to 6.1.0 (dependabot\[bot]) [#61244](https://github.com/nodejs/node/pull/61244)
* \[[`c0ef2a122e`](https://github.com/nodejs/node/commit/c0ef2a122e)] - **meta**: bump actions/cache from 4.3.0 to 5.0.1 (dependabot\[bot]) [#61243](https://github.com/nodejs/node/pull/61243)
* \[[`ab4453c4ac`](https://github.com/nodejs/node/commit/ab4453c4ac)] - **meta**: bump github/codeql-action from 4.31.6 to 4.31.9 (dependabot\[bot]) [#61241](https://github.com/nodejs/node/pull/61241)
* \[[`950d1e6f04`](https://github.com/nodejs/node/commit/950d1e6f04)] - **meta**: bump codecov/codecov-action from 5.5.1 to 5.5.2 (dependabot\[bot]) [#61240](https://github.com/nodejs/node/pull/61240)
* \[[`58676a1860`](https://github.com/nodejs/node/commit/58676a1860)] - **meta**: bump peter-evans/create-pull-request from 7.0.9 to 8.0.0 (dependabot\[bot]) [#61237](https://github.com/nodejs/node/pull/61237)
* \[[`d635f3ea0d`](https://github.com/nodejs/node/commit/d635f3ea0d)] - **meta**: move lukekarrys to emeritus (Node.js GitHub Bot) [#60985](https://github.com/nodejs/node/pull/60985)
* \[[`6baa79c78d`](https://github.com/nodejs/node/commit/6baa79c78d)] - **meta**: bump actions/setup-python from 6.0.0 to 6.1.0 (dependabot\[bot]) [#60927](https://github.com/nodejs/node/pull/60927)
* \[[`86b9791a00`](https://github.com/nodejs/node/commit/86b9791a00)] - **meta**: bump github/codeql-action from 4.31.3 to 4.31.6 (dependabot\[bot]) [#60926](https://github.com/nodejs/node/pull/60926)
* \[[`8c05016556`](https://github.com/nodejs/node/commit/8c05016556)] - **meta**: bump peter-evans/create-pull-request from 7.0.8 to 7.0.9 (dependabot\[bot]) [#60924](https://github.com/nodejs/node/pull/60924)
* \[[`5efc492a09`](https://github.com/nodejs/node/commit/5efc492a09)] - **meta**: bump github/codeql-action from 4.31.2 to 4.31.3 (dependabot\[bot]) [#60770](https://github.com/nodejs/node/pull/60770)
* \[[`a64f655166`](https://github.com/nodejs/node/commit/a64f655166)] - **meta**: bump step-security/harden-runner from 2.13.1 to 2.13.2 (dependabot\[bot]) [#60769](https://github.com/nodejs/node/pull/60769)
* \[[`e8f9ea6bda`](https://github.com/nodejs/node/commit/e8f9ea6bda)] - **meta**: add Renegade334 to collaborators (Renegade334) [#60714](https://github.com/nodejs/node/pull/60714)
* \[[`5d1ab8a783`](https://github.com/nodejs/node/commit/5d1ab8a783)] - **meta**: bump actions/download-artifact from 5.0.0 to 6.0.0 (dependabot\[bot]) [#60532](https://github.com/nodejs/node/pull/60532)
* \[[`9fee83bf50`](https://github.com/nodejs/node/commit/9fee83bf50)] - **meta**: bump actions/upload-artifact from 4.6.2 to 5.0.0 (dependabot\[bot]) [#60531](https://github.com/nodejs/node/pull/60531)
* \[[`cd496ba9a7`](https://github.com/nodejs/node/commit/cd496ba9a7)] - **meta**: bump github/codeql-action from 3.30.5 to 4.31.2 (dependabot\[bot]) [#60533](https://github.com/nodejs/node/pull/60533)
* \[[`d7667442be`](https://github.com/nodejs/node/commit/d7667442be)] - **meta**: bump actions/setup-node from 5.0.0 to 6.0.0 (dependabot\[bot]) [#60529](https://github.com/nodejs/node/pull/60529)
* \[[`9e19c60533`](https://github.com/nodejs/node/commit/9e19c60533)] - **meta**: bump actions/stale from 10.0.0 to 10.1.0 (dependabot\[bot]) [#60528](https://github.com/nodejs/node/pull/60528)
...
* \[[`0d73db0938`](https://github.com/nodejs/node/commit/0d73db0938)] - **node-api**: use Node-API in comments (Vladimir Morozov) [#61320](https://github.com/nodejs/node/pull/61320)
* \[[`522c4d8d83`](https://github.com/nodejs/node/commit/522c4d8d83)] - **node-api**: support SharedArrayBuffer in napi\_create\_dataview (Kevin Eady) [#60473](https://github.com/nodejs/node/pull/60473)
* \[[`52c13d0285`](https://github.com/nodejs/node/commit/52c13d0285)] - **node-api**: use local files for instanceof test (Vladimir Morozov) [#60190](https://github.com/nodejs/node/pull/60190)
* \[[`4742b18cef`](https://github.com/nodejs/node/commit/4742b18cef)] - **os**: freeze signals constant (Xavier Stouder) [#61038](https://github.com/nodejs/node/pull/61038)
* \[[`461bee2522`](https://github.com/nodejs/node/commit/461bee2522)] - **perf\_hooks**: fix stack overflow error (Antoine du Hamel) [#60084](https://github.com/nodejs/node/pull/60084)
* \[[`ab588c031b`](https://github.com/nodejs/node/commit/ab588c031b)] - **perf\_hooks**: move non-standard performance properties to perf\_hooks (Chengzhong Wu) [#60370](https://github.com/nodejs/node/pull/60370)
...
* \[[`687702d461`](https://github.com/nodejs/node/commit/687702d461)] - **src**: add missing override specifier to Clean() (Tobias Nießen) [#61429](https://github.com/nodejs/node/pull/61429)
* \[[`5ca9310a28`](https://github.com/nodejs/node/commit/5ca9310a28)] - **src**: cache context lookup in vectored io loops (Mert Can Altin) [#61387](https://github.com/nodejs/node/pull/61387)
* \[[`5da4539591`](https://github.com/nodejs/node/commit/5da4539591)] - **src**: use C++ nullptr in webstorage (Tobias Nießen) [#61407](https://github.com/nodejs/node/pull/61407)
* \[[`517f2ed159`](https://github.com/nodejs/node/commit/517f2ed159)] - **src**: fix pointer alignment (jhofstee) [#61336](https://github.com/nodejs/node/pull/61336)
* \[[`3433bd9ca3`](https://github.com/nodejs/node/commit/3433bd9ca3)] - **src**: dump snapshot source with node:generate\_default\_snapshot\_source (Joyee Cheung) [#61101](https://github.com/nodejs/node/pull/61101)
* \[[`71a6cc8e84`](https://github.com/nodejs/node/commit/71a6cc8e84)] - **src**: add HandleScope to edge loop in heap\_utils (Mert Can Altin) [#60885](https://github.com/nodejs/node/pull/60885)
* \[[`60e7d4c29e`](https://github.com/nodejs/node/commit/60e7d4c29e)] - **src**: remove redundant CHECK (Tobias Nießen) [#61130](https://github.com/nodejs/node/pull/61130)
* \[[`05ec856576`](https://github.com/nodejs/node/commit/05ec856576)] - **src**: fix off-thread cert loading in bundled cert mode (Joyee Cheung) [#60764](https://github.com/nodejs/node/pull/60764)
* \[[`3743bddf86`](https://github.com/nodejs/node/commit/3743bddf86)] - **src**: handle DER decoding errors from system certificates (Joyee Cheung) [#60787](https://github.com/nodejs/node/pull/60787)
* \[[`859583a44f`](https://github.com/nodejs/node/commit/859583a44f)] - **src**: use static\_cast instead of C-style cast (Michaël Zasso) [#60868](https://github.com/nodejs/node/pull/60868)
* \[[`f237e00ced`](https://github.com/nodejs/node/commit/f237e00ced)] - **src**: move Node-API version detection to where it is used (Anna Henningsen) [#60512](https://github.com/nodejs/node/pull/60512)
* \[[`d782ac37aa`](https://github.com/nodejs/node/commit/d782ac37aa)] - **src**: avoid C strings in more C++ exception throws (Anna Henningsen) [#60592](https://github.com/nodejs/node/pull/60592)
* \[[`ef1b4556ca`](https://github.com/nodejs/node/commit/ef1b4556ca)] - **src**: move `napi_addon_register_func` to `node_api_types.h` (Anna Henningsen) [#60512](https://github.com/nodejs/node/pull/60512)
* \[[`1337612852`](https://github.com/nodejs/node/commit/1337612852)] - **src**: remove unconditional NAPI\_EXPERIMENTAL in node.h (Chengzhong Wu) [#60345](https://github.com/nodejs/node/pull/60345)
* \[[`9127c3c13f`](https://github.com/nodejs/node/commit/9127c3c13f)] - **src**: clean up generic counter implementation (Anna Henningsen) [#60447](https://github.com/nodejs/node/pull/60447)
* \[[`4ebf6d90c2`](https://github.com/nodejs/node/commit/4ebf6d90c2)] - **src**: add enum handle for ToStringHelper + formatting (Burkov Egor) [#56829](https://github.com/nodejs/node/pull/56829)
...
* \[[`ae651198e0`](https://github.com/nodejs/node/commit/ae651198e0)] - **src,permission**: fix permission.has on empty param (Rafael Gonzaga) [#60674](https://github.com/nodejs/node/pull/60674)
* \[[`6d37349a19`](https://github.com/nodejs/node/commit/6d37349a19)] - **src,permission**: add debug log on is\_tree\_granted (Rafael Gonzaga) [#60668](https://github.com/nodejs/node/pull/60668)
* \[[`d7eabf6cbf`](https://github.com/nodejs/node/commit/d7eabf6cbf)] - **stream**: fix isErrored/isWritable for WritableStreams (René) [#60905](https://github.com/nodejs/node/pull/60905)
* \[[`f5a3fd9e96`](https://github.com/nodejs/node/commit/f5a3fd9e96)] - **stream**: don't try to read more if reading (Robert Nagy) [#60454](https://github.com/nodejs/node/pull/60454)
* \[[`234f8dce7c`](https://github.com/nodejs/node/commit/234f8dce7c)] - **test**: skip --build-sea tests on platforms where SEA is flaky (Joyee Cheung) [#61504](https://github.com/nodejs/node/pull/61504)
* \[[`a76757818b`](https://github.com/nodejs/node/commit/a76757818b)] - **test**: fix flaky debugger test (Ryuhei Shima) [#58324](https://github.com/nodejs/node/pull/58324)
* \[[`70cfb7a16c`](https://github.com/nodejs/node/commit/70cfb7a16c)] - **test**: ensure removeListener event fires for once() listeners (sangwook) [#60137](https://github.com/nodejs/node/pull/60137)
* \[[`2419284b1a`](https://github.com/nodejs/node/commit/2419284b1a)] - **test**: delay writing the files only on macOS (Luigi Pinca) [#61532](https://github.com/nodejs/node/pull/61532)
* \[[`46dd413a44`](https://github.com/nodejs/node/commit/46dd413a44)] - **test**: asserts that import.meta.resolve invokes sync loader hooks (Chengzhong Wu) [#61158](https://github.com/nodejs/node/pull/61158)
* \[[`e0f75596b0`](https://github.com/nodejs/node/commit/e0f75596b0)] - **test**: check util.parseArgs argv parsing with actual process execution (René) [#61089](https://github.com/nodejs/node/pull/61089)
* \[[`1545be15c4`](https://github.com/nodejs/node/commit/1545be15c4)] - **test**: remove unneccessary repl magic\_mode tests (Dario Piotrowicz) [#61053](https://github.com/nodejs/node/pull/61053)
* \[[`c9830e5086`](https://github.com/nodejs/node/commit/c9830e5086)] - **test**: skip sea tests on riscv64 (Stewart X Addison) [#61111](https://github.com/nodejs/node/pull/61111)
* \[[`9abdd6994c`](https://github.com/nodejs/node/commit/9abdd6994c)] - **test**: mark stringbytes-external-max flaky on AIX (Stewart X Addison) [#60995](https://github.com/nodejs/node/pull/60995)
* \[[`64fc2671ec`](https://github.com/nodejs/node/commit/64fc2671ec)] - **test**: update test426 fixtures (Rich Trott) [#60982](https://github.com/nodejs/node/pull/60982)
* \[[`1e4a9704e2`](https://github.com/nodejs/node/commit/1e4a9704e2)] - **test**: skip SEA inspect test if inspector is not available (Livia Medeiros) [#60872](https://github.com/nodejs/node/pull/60872)
* \[[`249683fc33`](https://github.com/nodejs/node/commit/249683fc33)] - **test**: use `assert.match` for non-literal regexp tests (René) [#60879](https://github.com/nodejs/node/pull/60879)
* \[[`5c536250e9`](https://github.com/nodejs/node/commit/5c536250e9)] - **test**: fix embedtest in debug windows (Vladimir Morozov) [#60806](https://github.com/nodejs/node/pull/60806)
* \[[`895e370104`](https://github.com/nodejs/node/commit/895e370104)] - **test**: fix debug test crashes caused by sea tests (Vladimir Morozov) [#60807](https://github.com/nodejs/node/pull/60807)
* \[[`65166d4780`](https://github.com/nodejs/node/commit/65166d4780)] - **test**: replace deprecated regex test assertions in http trailers test (Aditya Chopra) [#60831](https://github.com/nodejs/node/pull/60831)
* \[[`268fd2e706`](https://github.com/nodejs/node/commit/268fd2e706)] - **test**: prefer major GC in cppgc-object teardown (sangwook) [#60672](https://github.com/nodejs/node/pull/60672)
* \[[`fdd300394a`](https://github.com/nodejs/node/commit/fdd300394a)] - **test**: skip test that cause timeout on IBM i (SRAVANI GUNDEPALLI) [#60700](https://github.com/nodejs/node/pull/60700)
* \[[`d527a61b26`](https://github.com/nodejs/node/commit/d527a61b26)] - **test**: limit the concurrency of WPTRunner for RISC-V (Levi Zim) [#60591](https://github.com/nodejs/node/pull/60591)
* \[[`09b5540b87`](https://github.com/nodejs/node/commit/09b5540b87)] - **test**: fix test-strace-openat-openssl for RISC-V (Levi Zim) [#60588](https://github.com/nodejs/node/pull/60588)
* \[[`c4a64ffebd`](https://github.com/nodejs/node/commit/c4a64ffebd)] - **test**: fix status when compiled without inspector (Antoine du Hamel) [#60289](https://github.com/nodejs/node/pull/60289)
* \[[`5d03d78a9b`](https://github.com/nodejs/node/commit/5d03d78a9b)] - **test**: deflake test-perf-hooks-timerify-histogram-sync (Joyee Cheung) [#60639](https://github.com/nodejs/node/pull/60639)
* \[[`f5b88d4092`](https://github.com/nodejs/node/commit/f5b88d4092)] - **test**: apply a delay to `watch-mode-kill-signal` tests (Joyee Cheung) [#60610](https://github.com/nodejs/node/pull/60610)
* \[[`8762aef52b`](https://github.com/nodejs/node/commit/8762aef52b)] - **test**: async iife in repl (Tony Gorez) [#44878](https://github.com/nodejs/node/pull/44878)
* \[[`99d9876bd4`](https://github.com/nodejs/node/commit/99d9876bd4)] - **test**: parallelize sea tests when there's enough disk space (Joyee Cheung) [#60604](https://github.com/nodejs/node/pull/60604)
* \[[`55cac2c328`](https://github.com/nodejs/node/commit/55cac2c328)] - **test**: only show overridden env in child process failures (Joyee Cheung) [#60556](https://github.com/nodejs/node/pull/60556)
* \[[`210bf41e6c`](https://github.com/nodejs/node/commit/210bf41e6c)] - **test**: split test-perf-hooks-timerify (Joyee Cheung) [#60568](https://github.com/nodejs/node/pull/60568)
* \[[`56b03c3e85`](https://github.com/nodejs/node/commit/56b03c3e85)] - **test**: add more logs to test-esm-loader-hooks-inspect-wait (Joyee Cheung) [#60466](https://github.com/nodejs/node/pull/60466)
* \[[`8b2c227504`](https://github.com/nodejs/node/commit/8b2c227504)] - **test**: mark stringbytes-external-exceed-max tests as flaky on AIX (Joyee Cheung) [#60565](https://github.com/nodejs/node/pull/60565)
* \[[`0a8ef0bb34`](https://github.com/nodejs/node/commit/0a8ef0bb34)] - **test**: correct conditional secure heap flags test (Shelley Vohr) [#60385](https://github.com/nodejs/node/pull/60385)
* \[[`3809b5a832`](https://github.com/nodejs/node/commit/3809b5a832)] - **test**: fix flaky test-watch-mode-kill-signal-\* (Joyee Cheung) [#60443](https://github.com/nodejs/node/pull/60443)
* \[[`d75da0e3bd`](https://github.com/nodejs/node/commit/d75da0e3bd)] - **test**: capture stack trace in debugger timeout errors (Joyee Cheung) [#60457](https://github.com/nodejs/node/pull/60457)
...
* \[[`95451e3591`](https://github.com/nodejs/node/commit/95451e3591)] - **tools**: switch to ARM runners on GHA jobs (Antoine du Hamel) [#61903](https://github.com/nodejs/node/pull/61903)
* \[[`1ceee951b7`](https://github.com/nodejs/node/commit/1ceee951b7)] - **tools**: avoid building twice in coverage jobs (Antoine du Hamel) [#61899](https://github.com/nodejs/node/pull/61899)
* \[[`4ef4225b83`](https://github.com/nodejs/node/commit/4ef4225b83)] - **tools**: use ubuntu-slim runner in GHA (Antoine du Hamel) [#61759](https://github.com/nodejs/node/pull/61759)
* \[[`96ca67082c`](https://github.com/nodejs/node/commit/96ca67082c)] - **tools**: use ubuntu-slim runner in GHA (Antoine du Hamel) [#61734](https://github.com/nodejs/node/pull/61734)
* \[[`6ef0d48ec6`](https://github.com/nodejs/node/commit/6ef0d48ec6)] - **tools**: use ubuntu-latest runner in `notify-on-push` workflow (Antoine du Hamel) [#61742](https://github.com/nodejs/node/pull/61742)
* \[[`80ee865e03`](https://github.com/nodejs/node/commit/80ee865e03)] - **tools**: use ubuntu-slim runner in meta GitHub Actions (Tierney Cyren) [#61663](https://github.com/nodejs/node/pull/61663)
* \[[`2bc4376869`](https://github.com/nodejs/node/commit/2bc4376869)] - **tools**: update gyp-next to 0.21.1 (Node.js GitHub Bot) [#61528](https://github.com/nodejs/node/pull/61528)
* \[[`14f39bb44d`](https://github.com/nodejs/node/commit/14f39bb44d)] - **tools**: fix vcbuild lint-js-build (Vladimir Morozov) [#61318](https://github.com/nodejs/node/pull/61318)
* \[[`631a5ca109`](https://github.com/nodejs/node/commit/631a5ca109)] - **tools**: only report commit validation failure on Slack (Antoine du Hamel) [#61124](https://github.com/nodejs/node/pull/61124)
* \[[`519b8188ab`](https://github.com/nodejs/node/commit/519b8188ab)] - **tools**: use sparse-checkout in linter jobs (Antoine du Hamel) [#61123](https://github.com/nodejs/node/pull/61123)
* \[[`e23f4f1434`](https://github.com/nodejs/node/commit/e23f4f1434)] - **tools**: simplify `notify-on-push` (Antoine du Hamel) [#61050](https://github.com/nodejs/node/pull/61050)
* \[[`772cdceda7`](https://github.com/nodejs/node/commit/772cdceda7)] - **tools**: fix update-nghttp2 signature verification (Richard Lau) [#61035](https://github.com/nodejs/node/pull/61035)
* \[[`b6c8c87dfd`](https://github.com/nodejs/node/commit/b6c8c87dfd)] - **tools**: improve log output of `create-release-proposal` (Antoine du Hamel) [#61028](https://github.com/nodejs/node/pull/61028)
* \[[`8df3ae995a`](https://github.com/nodejs/node/commit/8df3ae995a)] - **tools**: fix `vcbuild test` when path contain spaces (stduhpf) [#56481](https://github.com/nodejs/node/pull/56481)
* \[[`15eb840292`](https://github.com/nodejs/node/commit/15eb840292)] - **tools**: do not run `test-linux` workflow for changes on `vcbuild.bat` (Antoine du Hamel) [#60979](https://github.com/nodejs/node/pull/60979)
* \[[`4e321a78e0`](https://github.com/nodejs/node/commit/4e321a78e0)] - **tools**: disable some new cpplint rules before update (Michaël Zasso) [#60901](https://github.com/nodejs/node/pull/60901)
* \[[`615c86fcef`](https://github.com/nodejs/node/commit/615c86fcef)] - **tools**: don't fetch V8 deps in the source tree (Richard Lau) [#60883](https://github.com/nodejs/node/pull/60883)
* \[[`91ff1f86f5`](https://github.com/nodejs/node/commit/91ff1f86f5)] - **tools**: add temporal updater (Chengzhong Wu) [#60828](https://github.com/nodejs/node/pull/60828)
* \[[`ddf7552f20`](https://github.com/nodejs/node/commit/ddf7552f20)] - **tools**: dump config.gypi as json (Chengzhong Wu) [#60794](https://github.com/nodejs/node/pull/60794)
* \[[`3a3130a27c`](https://github.com/nodejs/node/commit/3a3130a27c)] - **tools**: bump js-yaml from 4.1.0 to 4.1.1 in /tools/lint-md (dependabot\[bot]) [#60781](https://github.com/nodejs/node/pull/60781)
* \[[`6944ebf826`](https://github.com/nodejs/node/commit/6944ebf826)] - **tools**: bump js-yaml from 4.1.0 to 4.1.1 in /tools/doc in the doc group (dependabot\[bot]) [#60766](https://github.com/nodejs/node/pull/60766)
* \[[`c755e0e11c`](https://github.com/nodejs/node/commit/c755e0e11c)] - **tools**: remove unsupported `cooldown` from Dependabot config (Antoine du Hamel) [#60747](https://github.com/nodejs/node/pull/60747)
* \[[`09448f06f8`](https://github.com/nodejs/node/commit/09448f06f8)] - **tools**: update sccache to v0.12.0 (Michaël Zasso) [#60723](https://github.com/nodejs/node/pull/60723)
* \[[`cde1d43891`](https://github.com/nodejs/node/commit/cde1d43891)] - **tools**: update gyp-next to 0.21.0 (Node.js GitHub Bot) [#60645](https://github.com/nodejs/node/pull/60645)
* \[[`a033cc5d38`](https://github.com/nodejs/node/commit/a033cc5d38)] - **tools**: replace invalid expression in dependabot config (Riddhi) [#60649](https://github.com/nodejs/node/pull/60649)
* \[[`141125f534`](https://github.com/nodejs/node/commit/141125f534)] - **tools**: skip unaffected GHA jobs for changes in `test/internet` (Antoine du Hamel) [#60517](https://github.com/nodejs/node/pull/60517)
* \[[`a658e1633e`](https://github.com/nodejs/node/commit/a658e1633e)] - **tools**: do not use short hashes for deps versioning to avoid collision (Antoine du Hamel) [#60407](https://github.com/nodejs/node/pull/60407)
* \[[`f8a61be689`](https://github.com/nodejs/node/commit/f8a61be689)] - **tools**: fix update-icu script (Michaël Zasso) [#60521](https://github.com/nodejs/node/pull/60521)
* \[[`b9ae35c7a5`](https://github.com/nodejs/node/commit/b9ae35c7a5)] - **tools**: fix linter for semver-major release proposals (Antoine du Hamel) [#60481](https://github.com/nodejs/node/pull/60481)
* \[[`36eef22d07`](https://github.com/nodejs/node/commit/36eef22d07)] - **tools**: fix failing release-proposal linter for LTS transitions (Antoine du Hamel) [#60465](https://github.com/nodejs/node/pull/60465)
* \[[`a838d39286`](https://github.com/nodejs/node/commit/a838d39286)] - **tools**: remove undici from daily wpt.fyi job (Filip Skokan) [#60444](https://github.com/nodejs/node/pull/60444)
...
* \[[`4cf4c4f087`](https://github.com/nodejs/node/commit/4cf4c4f087)] - **tools,doc**: fix format-md files list (Stefan Stojanovic) [#61147](https://github.com/nodejs/node/pull/61147)
* \[[`300b888bdd`](https://github.com/nodejs/node/commit/300b888bdd)] - **tools,doc**: update JavaScript primitive types to match MDN Web Docs (JustApple) [#60581](https://github.com/nodejs/node/pull/60581)
* \[[`9951cd559c`](https://github.com/nodejs/node/commit/9951cd559c)] - **typings**: add typing for string\_decoder (Taejin Kim) [#61368](https://github.com/nodejs/node/pull/61368)
...
* \[[`4060761406`](https://github.com/nodejs/node/commit/4060761406)] - **url**: add fast path to getPathFromURL decoder (Gürgün Dayıoğlu) [#60749](https://github.com/nodejs/node/pull/60749)
* \[[`fe96492296`](https://github.com/nodejs/node/commit/fe96492296)] - **url**: remove array.reduce usage (Gürgün Dayıoğlu) [#60748](https://github.com/nodejs/node/pull/60748)
* \[[`9c50361674`](https://github.com/nodejs/node/commit/9c50361674)] - **util**: optimize toASCIILower function using V8s native toLowerCase (Mert Can Altin) [#61107](https://github.com/nodejs/node/pull/61107)
* \[[`2c16ff3fa8`](https://github.com/nodejs/node/commit/2c16ff3fa8)] - **util**: limit `inspect` to only show own properties (Ruben Bridgewater) [#61032](https://github.com/nodejs/node/pull/61032)
* \[[`cadf09f6f2`](https://github.com/nodejs/node/commit/cadf09f6f2)] - **util**: fix parseArgs skipping positional arg with --eval and --print (azadgupta1) [#60814](https://github.com/nodejs/node/pull/60814)
* \[[`3932c0bd72`](https://github.com/nodejs/node/commit/3932c0bd72)] - **util**: assert getCallSites does not invoke Error.prepareStackTrace (Chengzhong Wu) [#60922](https://github.com/nodejs/node/pull/60922)
* \[[`075c3febb0`](https://github.com/nodejs/node/commit/075c3febb0)] - **util**: fix stylize of special properties in inspect (Ge Gao) [#60479](https://github.com/nodejs/node/pull/60479)
...
* \[[`0fba4252c1`](https://github.com/nodejs/node/commit/0fba4252c1)] - **worker**: update code examples for `node:worker_threads` module (fisker Cheung) [#58264](https://github.com/nodejs/node/pull/58264)
* \[[`9b2b31c719`](https://github.com/nodejs/node/commit/9b2b31c719)] - **worker**: remove not implemented declarations (Artur Gawlik) [#60655](https://github.com/nodejs/node/pull/60655)
* \[[`3595d2e2eb`](https://github.com/nodejs/node/commit/3595d2e2eb)] - **zlib**: validate write\_result array length (Ryuhei Shima) [#61342](https://github.com/nodejs/node/pull/61342)
